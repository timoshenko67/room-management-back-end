...
public class RoomController {
    ...
    public ResponseEntity<Room> getRoomById(@PathVariable("id") long roomId)
        ...
        Room room = roomRepository.findById(roomId).orElseThrow(() -> new ResourceNotFoundException("No room was found with this ID: " + roomId));
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable("id") Long roomId, @Valid @RequestBody Room roomDetails)
        ...
        Room room = roomRepository.findById(roomId)
                .orElseThrow(() -> new ResourceNotFoundException("No room was found with this ID: " + roomId));
